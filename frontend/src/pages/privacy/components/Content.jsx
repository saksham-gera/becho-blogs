...
function Content() {
  return (
    <div className="w-full max-w-[800px] h-[80vh] my-[5vh] mx-auto border-[1px] border-solid border-[#ddd] rounded-lg overflow-y-scroll bg-white">
      <div className="text-black leading-6">
        ...
        By signing up with us, you agree to receive messages from us via SMS on marketplace activity, safeguarding measures, identity confirmation, and additional updates. We will never provide your information to third parties for marketing purposes.
        ...
        Freelancer, with its partnership and commitment to Security and Privacy with Microsoft, also provides a link to their Privacy Statement.
        ...
        By Email:
        privacy-officer@freelancer.com

        By Mail:
        Attn: Privacy Officer
        Level 37, Grosvenor Place
        225 George Street, NSW 2000 Australia
